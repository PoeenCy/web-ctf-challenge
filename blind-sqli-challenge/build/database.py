...
FLAG = open('flag.txt', 'r').read().strip() if os.path.exists('flag.txt') and open('flag.txt', 'r').read().strip().startswith("poeency{") else 'poeency{this_is_a_flag}'
# Nevermind :v
...
def init_db():
    ...
    products_data = [
        ...
        ("Tablet", 30.00, "/static/tablet.jpg", "This is a very basic tablet of poeency", 1),
